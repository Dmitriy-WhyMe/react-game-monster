...
const Index = () => {
    ...
    React.useEffect(() => {
        window.scrollTo(0, 0)
        axios.get(`
            https://6297004814e756fe3b26c094.mockapi.io/Games?id=${params.id}
        `).then(res => {
            setGameData(res.data.find(item => item.id === params.id)) 
            setIsLoading(false)
        })
    }, [params.id])
  return (
    <div className="container card">
      <div className="card__block-top">
        <div className="card__slider">
          <div className="swiper-container card__slider-1">
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <img src="img/card/Rectangle 49.png" alt="" />
              </div>
              <div className="swiper-slide">
                <img src="img/card/Rectangle 49.png" alt="" />
              </div>
          ...
          <div className="swiper-container card__slider-2">
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <img src="img/card/Rectangle 50.png" alt="" />
              </div>
              <div className="swiper-slide">
                <img src="img/card/Rectangle 51.png" alt="" />
              </div>
              <div className="swiper-slide">
                <img src="img/card/Rectangle 52.png" alt="" />
              </div>
              <div className="swiper-slide">
                <img src="img/card/Rectangle 53.png" alt="" />
              </div>
              <div className="swiper-slide">
                <img src="img/card/Rectangle 50.png" alt="" />
              </div>
              <div className="swiper-slide">
                <img src="img/card/Rectangle 55.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        <div className="card__info">
          ...
          <div className="card__subtitle">
            {isLoading === false 
                ? gameData.info.map((value,index) => <button className="btn" key={index}>{value}</button>)
                : false
            }
          </div>
        ...
        <div className="card__acount">
          ...
          <div className="card__body">
            <div className="card__body-left">
              <button href="#">Witcher 3: Wild Hunt </button>
              <button className="active" href="#">Overwatch Delux Edition</button>
              <button href="#">Cyberpunk 2077</button>
            </div>
            <button className="card__body-right" href="#">Арендовать аккаунт</button>
          </div>
        </div>
      </div>
      <section className="index-katalog">
        ...
        <div className="flex">
          <button className="katalog__item" href="#">
            <img src="../../img/katalog/Mask Group.png" alt=""/>
            <div className="katalog__infos">
              <div className="katalog__info-main">Эксклюзив</div>
              <div className="katalog__info-dop">Предзаказ</div>
            </div>
            <div className="katalog__price">
              <div className="katalog__price-main">1 199₽</div>
              <div className="katalog__price-old">3 499₽</div>
            </div>
            <div className="katalog__discount">-35%</div>
            <div className="katalog__title">
              <h4>Witcher 3: Wild Hunt</h4>
            ...
            <div className="katalog__category">
              <div className="katalog__category-item">RPG</div>
              <div className="katalog__category-item">Экшен</div>
            </div>
          </button>
          <button className="katalog__item" href="#">
          ...
          <button className="katalog__item" href="#">
            <img src="../../img/katalog/Mask Group (2).png" alt="" />
            <div className="katalog__infos">
              <div className="katalog__info-main">Эксклюзив</div>
              <div className="katalog__info-dop">Предзаказ</div>
            </div>
          ...
          <button className="katalog__item" href="#">
            <img src="../../img/katalog/thumb-1920-865978.jpg" alt="" />
            <div className="katalog__infos">
              <div className="katalog__info-main">Эксклюзив</div>
              <div className="katalog__info-dop">Предзаказ</div>
            </div>
