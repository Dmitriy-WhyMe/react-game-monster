...
type CartItemProps = {
    id: string, title: string, price: number, count: number, imageUrl: string
}
const Index: React.FC<CartItemProps> = ({ id, title, price, count, imageUrl }) => {
    ...
    return (
        <div className={style.item}>
            ...
            <div className={style.Count}>
                <div onClick={(count > 1) ? onClickMinus : onClickRemove} className={style.minus}>
            ...
            <div onClick={onClickRemove} className={style.remove}>
